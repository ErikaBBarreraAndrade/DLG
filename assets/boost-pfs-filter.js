...
var boostPFSTemplate = {
	// Grid Template
	'productGridItemHtml': '<div data-limoniapps-discountninja-product-handle="{{itemHandle}}" data-product-handle={{itemHandle}} id="{{itemHandle}}" class="grid__item grid-product ' + boostPFSConfig.custom.grid_item_width + ' {{itemQuickShopClass}}" data-aos="row-of-' + boostPFSConfig.custom.products_per_row + '">' +
								'<div class="grid-product__content">' +
									...
									'<a href="{{itemUrl}}" class="grid-product__link {{itemSoldOutClass}}">' +
										...
										'<div class="grid-product__meta">' +
											...
											'{{itemVendor}}' +
											'<div class="grid-product__price limoniapps-discountninja-productprice">{{itemPrice}}</div>' +
											'{{itemReviews}}'+
										'</div>' +
									'</a>' +
								'</div>' +
	...
	// Sorting Template
	'sortingHtml': '<label for="boost-pfs-filter-top-sorting-select" class="hidden-label">' + '{{sortingLabel}}' + '</label><select class="boost-pfs-filter-top-sorting-select">{{sortingItems}}</select>',
};
...
(function () {
	...
	ProductSorting.prototype.compileTemplate = function() {
		...
		if (sortingArr) {
			...
			html = boostPFSTemplate.sortingHtml.replace(/{{sortingItems}}/g, sortingItemsHtml).replace(/{{sortingLabel}}/g, Labels.sorting);
		}
		return html;
	};
